...
const chalk = require('chalk');
  ...
  console.log((chalk.cyan(`                                    ╚═════╝    ╚═╝       ╚═╝  ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝ ╚═════╝      ╚═╝ ╚═════╝ ╚═╝  ╚═╝`)));
  console.log("");                                  
  console.log((chalk.yellow(`                                                               Crée par ASTRO 10K BG#9999 !`)));  
  console.log((chalk.yellow(`                                                                © 2020 Lixux, Inc.`))); 
  console.log("");                                   
  console.log((chalk.red(`                                                         Discord: https://discord.gg/Whx4EgkunG`)));      
  console.log((chalk.red(`                                                        Youtube: https://www.youtube.com/channel/UCo2vKsL7k4CfjzZ-aDEMW_g`)));   
  console.log("");                                  
  ...
  bot.user.setActivity("+help - AstroGenBg");
});
...
bot.on("message", message => {
    if (message.channel.id === config.botChannel) { 
        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                ...
                const embed = {
                    ...
                    footer: {
                        icon_url:
                            "https://i.imgur.com/y22sVN0.png",
                        text: "Développé par ASTRO 10K BG#9999"
                    },
                    image: {url:"https://i.imgur.com/AOz5NCe.gif"},
                    author: {
                        name: botname + " - générateur de compte",
                        url: "https://discord.gg/Whx4EgkunG",
                        ...
                        if (position != -1) {
                            ...
                            fs.writeFile(filePath, data, function (err) {
                                const embed = {
                                    ...
                                    timestamp: new Date(),
                                    footer: {
                                        icon_url: "https://i.imgur.com/y22sVN0.png",
                                        text: "Développé par ASTRO 10K BG#9999"
                                    },
                                    image: {
                                        url:
                                            "https://i.imgur.com/AOz5NCe.gif"
                                    },
                                    author: {
                                        name: botname + " - générateur de compte",
                                        url: "https://discord.gg/Whx4EgkunG",
            ...
            if (command === "help") {
                ...
                const embed = {
                    ...
                    description: '**Ceci est une liste de toutes les commandes du gen By ASTRO 10K BG#9999**',
                    fields: [
                        {
                        ...
                        {
                            name: 'Youtube  ' + botname,
                            name: 'https://www.youtube.com/channel/UCo2vKsL7k4CfjzZ-aDEMW_g  ' + botname,
                        },
                    ],
                    timestamp: new Date(),
                    footer: {
        ...
        if (command === "create") {
            ...
            let args = messageArray.slice(1);
            const filePath = __dirname + "/comptes/" + args[0] + ".txt";
            fs.writeFile(filePath, 'AstroQSM:AstroQSM', function (err) {
                if (err) throw err;
                const embed = {
                    title: "Service créé!",
